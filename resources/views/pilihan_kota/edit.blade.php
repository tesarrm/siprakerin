                        ...
                        <div class="flex justify-between lg:flex-row flex-col">
                            <div class="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
                                ...
                                {{-- <div class="mt-4 flex items-center">
                                    ...
                                    <div class="flex-1">
                                        <input value="{{ $siswa->nama }}" required id="reciever-name" type="text" name="nama" class="form-input w-full" 
                                ...
                                <div class="flex items-center mt-4">
                                    <label for="kota_id_1" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Pilihan 1<span class="text-danger">*</span></label>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-center mt-4">
                                    <label for="kota_id_2" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Pilihan 2<span class="text-danger">*</span></label>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-center mt-4">
                                    <label for="kota_id_3" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Pilihan 3<span class="text-danger">*</span></label>
                                    <div class="flex-1">
                                ...
                                <div class="mt-4 flex items-center">
                                    <label for="reciever-name" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Nama<span class="text-danger">*</span></label>
                                    <div class="flex-1">
                                        <input value="{{ old('nama', $siswa->nama) }}" required id="reciever-name" type="text" name="nama" class="form-input w-full" placeholder="Isi Nama" />
                                        @error('nama')
                                            <div class="mt-2 text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="flex items-center mt-4">
                                    <label for="status" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Status<span class="text-danger">*</span></label>
                                    <div class="flex-1">
                                        <select required id="status" name="status" class="form-select w-full">
