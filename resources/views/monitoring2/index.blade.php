                ...
                <ul class="flex flex-wrap mt-3 border-b border-white-light dark:border-[#191e3a]">
                    <li>
                        <a href="javascript:;"
                            ...
                            @click="tab = 'home'">Jadwal Monitoring</a>
                    </li>
                    <li>
                        <a href="javascript:;"
                            ...
                            @click="tab = 'profile'">Hasil Monitoring</a>
                    </li>
                </ul>
            </div>
                ...
                <template x-if="tab === 'home'">
                    <div class="active">
                        ...
                        <div x-data="invoiceList">
                            <div class="panel px-0" style="box-shadow: none">
                                <div class="px-5">
                                    <div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                                        <div class="flex items-center gap-2 mb-5">
                                            <button type="button" class="btn btn-danger gap-2" @click="deleteRow()">
                                                ...
                                                Hapus </button>
                                            <a href="/monitoring/create" class="btn btn-primary gap-2">
                            ...
                            },
                            {
                                ...
                                render: function(data, cell, row) {
                                    return `<div class="flex gap-4 items-center">
                                                <a href="/monitoring/${data}/edit" class="hover:text-info">
