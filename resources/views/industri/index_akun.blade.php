<x-layout.default>
    ...
    @php
        ...
        foreach ($data as $d) {
            $items[] = [
                'nama' => $d->user ? $d->user->name : '-',
                'nama_industri' => $d->user ? $d->user->name : '-',
                'no_telp' => $d->no_telp ?? '-',
                'action' => $d->user->id ?? '-',

                '_gambar' => $d->user ? $d->user->gambar : null,
                '_nama' => $d->user ? $d->user->name : '-',
                '_no_telp' => $d->no_telp ?? '-',
                '_user_id' => $d->user ? $d->user->id : '-',
            ];
        }
    @endphp
                                    ...
                                    return `<div class="items-center">
                                                <div x-data="dropdown" @click.outside="open = false"
                                                    ...
                                                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                                                        ...
                                                        <li><a href="#" @click="resetPassword('${row.cells[7].data}')">Reset Password</a></li>
                                                    </ul>
                                                </div>
                                                                    ...
                                                                    <div class="flex xl:flex-row flex-col gap-6">
                                                                        ...
                                                                        <div class="space-y-5 w-full px-0 flex-1">
                                                                            ...
                                                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                                                ...
                                                                                <div>
                                                                                    <label>Nama Industri<span class="text-danger">*</span></label>
