                ...
                <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                    ...
                    <div class="w-full max-w-[440px] lg:mt-16">
                        ...
                        <form action="{{ url('login') }}" method="POST" class="space-y-5 dark:text-white" ">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input name="email" id="Email" type="email" placeholder="Masukkan Email" class="form-input ps-10 placeholder:text-white-dark" />
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input name="password" id="Password" type="password" placeholder="Masukkan Password" class="form-input ps-10 placeholder:text-white-dark" />
                                    <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path opacity="0.5"
                        ...
                        <div class="relative my-7 text-center md:mb-9">
                            ...
                            <span class="relative bg-white px-2 font-bold uppercase text-white-dark dark:bg-dark dark:text-white-light">atau</span>
                        </div>
                    ...
                    <p class="absolute bottom-6 w-full text-center dark:text-white">
                        © <span id="footer-year">2022</span>. SIPRAKERIN All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
