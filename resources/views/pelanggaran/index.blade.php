                ...
                <div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                    <div class="flex items-center gap-2 mb-5">
                        <button type="button" class="btn btn-danger gap-2" @click="deleteRow()">
                            ...
                            Hapus </button>
                        <a href="/pelanggaran/create" class="btn btn-primary gap-2">
                ...
                },
                {
                    ...
                    render: function(data, cell, row) {
                        return `<div class="flex gap-4 items-center">
                                    <a href="/pelanggaran/${data}/edit" class="hover:text-info">
            ...
            Alpine.data('dataList', () => ({
                ...
                searchInvoice() {
                    return this.items.filter((d) =>
                        ...
                        (d.pelanggaran && d.pelanggaran.toLowerCase().includes(this.searchText)) ||
                        (d.solusi && d.solusi.toLowerCase().includes(this.searchText))
                    );
                },
