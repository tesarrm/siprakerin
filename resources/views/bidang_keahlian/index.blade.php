                ...
                <div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                    <div class="flex items-center gap-2 mb-5">
                        <button type="button" class="btn btn-danger gap-2" @click="deleteRow()">
                            ...
                            Hapus </button>
                        <a href="/bidangkeahlian/create" class="btn btn-primary gap-2">
            ...
            Alpine.data('dataList', () => ({
                        ...
                        columns: [
                            ...
                            },
                            {
                                ...
                                render: function(data, cell, row) {
                                    ...
                                    return `<a href="/bidangkeahlian/${id}/edit" class="hover:underline">${ data }</a>`;
                                }
                            },
                            {
                                select: 2,
                                ...
                                render: function(data, cell, row) {
                                    return `<div class="flex gap-4 items-center">
                                                <a href="/bidangkeahlian/${data}/edit" class="hover:text-info">
                    ...
                    if (this.selectedRows.length > 0) {
                        window.Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                fetch('/bidangkeahlian/delete-multiple', {
                                    method: 'POST',
                                    headers: {
                ...
                deleteSingleRow(id) {
                    window.Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            fetch(`/bidangkeahlian/${id}/delete`, {
                                method: 'GET',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'X-CSRF-TOKEN': '{{ csrf_token() }}'
