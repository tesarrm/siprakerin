                    ...
                    <div class=" px-4">
                        <div class="flex justify-between lg:flex-row flex-col">
                            <div class="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
                                <div class="text-lg font-semibold">Data Siswa</div>
                                <div class="mt-4 flex items-center">
                                    <label for="nis" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">NIS<span class="text-danger">*</span></label>
                                    <div class="flex-1">
                                ...
                                <div class="flex items-center mt-4">
                                    <label for="kelas_id" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Kelas<span class="text-danger">*</span></label>
                                    <div class="flex-1">
                                        <select required id="kelas_id" name="kelas_id" class="form-select w-full">
                                            <option value="">Pilih Kelas</option>
                                            @foreach($kelas as $item)
                                                <option value="{{ $item->id }}" @selected($data->kelas_id == $item->id)>{{ $item->nama }}</option>
                                            @endforeach
                                        </select>
                                        @error('kelas_id')
                                            <div class="mt-2 text-danger">{{ $message }}</div>
                            ...
                            <div class="lg:w-1/2 w-full">
                                <div class="flex items-center mt-11">
                                    ...
                                    <div class="flex-1">
                                        <input value="{{ $data->username }}" required id="acno" type="text" name="username" class="form-input w-full"
