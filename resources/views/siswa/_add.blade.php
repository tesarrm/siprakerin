                        ...
                        <div class="flex justify-between lg:flex-row flex-col">
                            ...
                            <div class="lg:w-1/2 w-full">
                                <div class="flex items-center mt-11">
                                    <label for="acno" class="ltr:mr-2 rtl:ml-2 w-1/3 mb-0">Email<span class="text-danger">*</span></label>
                                    <div class="flex-1">
                                        <input required id="acno" type="text" name="email" class="form-input w-full"
