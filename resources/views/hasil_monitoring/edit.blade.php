<x-layout.default>
                    ...
                    <div class=" px-4">
                        ...
                        <div class="flex xl:flex-row flex-col gap-6">
                            <div class="xl:w-[600px] w-full xl:mt-0 mt-6">
                                <div class="mb-4 mt-2">
                                    {{-- <img src="/storage/blank_profile.png" alt="image"
                                        class="xl:w-52 xl:h-52 w-60 h-60 rounded-full object-cover mx-auto border-[#eee] border-4" /> --}}
    ...
    <script>
        ...
        @if($jadwal_monitoring->gambar)
        pond.addFile("{{ asset('storage/posts/' . $jadwal_monitoring->gambar) }}")
            .then(file => {
