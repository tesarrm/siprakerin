<x-layout.default>
        ...
        <form action="{{ url('hasilmonitoring') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex xl:flex-row flex-col gap-2.5">
                <div class="panel px-0 flex-1 py-6 ltr:xl:mr-6 rtl:xl:ml-6">
                    ...
                    <div class=" px-4">
                        <div class="text-lg font-semibold mb-4">Data Monitoring</div>
                        <div class="flex xl:flex-row flex-col gap-6">
                            <div class="xl:w-[600px] w-full xl:mt-0 mt-6">
                                <div class="mb-4 mt-2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2">
                                                        <div style="width: 80px;">
                                                            <input type="number" :name="'data['+index+'][hadir]'" x-model="row.hadir" class="form-input w-full" />
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <div style="width: 80px;">
                                                            <input type="number" :name="'data['+index+'][izin]'" x-model="row.izin" class="form-input w-full" />
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <div style="width: 80px;">
                                                            <input type="number" :name="'data['+index+'][alpa]'" x-model="row.alpa" class="form-input w-full" />
                                                        </div>
                                                    </td>
                                                    <td class="px-4 py-2">
                                                        <div style="width: 300px;">
                                                            <textarea rows="2" :name="'data['+index+'][catatan]'" x-model="row.catatan" class="form-textarea"></textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </template>
                    ...
                    <div class="mt-8 px-4">
                        <div class="flex justify-end items-center mt-8 gap-4">
                            <button type="submit" class="btn btn-success gap-2">
                                ...
                                <a href="{{url('hasilmonitoring')}}" class="btn btn-outline-danger gap-2">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-2 rtl:ml-2 shrink-0">
    ...
    <script>
        ...
        @if($monitoring_image && $monitoring_image->gambar)
        pond.addFile("{{ asset('storage/posts/' . $monitoring_image->gambar) }}")
            .then(file => {
