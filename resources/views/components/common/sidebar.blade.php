    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                @if(auth()->user()->can('r_guru') || auth()->user()->can('r_kelas') || auth()->user()->can('r_siswa'))
                <h2
                ...
                @if(auth()->user()->can('r_industri') || auth()->user()->can('r_kuota_industri'))
                <h2
                    class="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                ...
                @if(auth()->user()->can('r_pilihan_kota') || auth()->user()->can('r_penempatan_prakerin') || auth()->user()->can('r_jurnal'))
                <h2
                    class="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                ...
                @if(auth()->user()->can('r_jadwal_monitoring') || auth()->user()->can('r_hasil_monitoring'))
                <h2
                    class="py-3 px-7 flex items-center uppercase font-extrabold bg-white-light/30 dark:bg-dark dark:bg-opacity-[0.08] -mx-4 mb-1">
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="/bidang-keahlian" class="group">
                                <div class="flex items-center">
                        ...
                        <li class="nav-item">
                            <a href="/capaian" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Capaian</span>
                                </div>
                            </a>
                        </li>
                    </ul>
