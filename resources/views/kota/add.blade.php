        ...
        <form action="{{ url('kota') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex xl:flex-row flex-col gap-2.5">
                <div class="panel xl:w-[600px] px-0 w-full xl:mt-0 mt-6">
                    <div class=" px-4">
                        <div class="text-lg font-semibold mb-4">Data Kota</div>
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input required id="biaya" type="number" name="biaya" class="form-input w-full" 
                    ...
                    <div class="mt-8 px-4">
                        <div class="flex justify-end items-center mt-8 gap-4">
                            ...
                            <a href="{{url('kota')}}" class="btn btn-outline-danger gap-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-2 rtl:ml-2 shrink-0">
