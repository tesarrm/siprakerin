                        ...
                        <div class="flex justify-between lg:flex-row flex-col">
                            <div class="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <div class="flex-1">
                                        <input required id="password" type="password" name="password" class="form-input w-full" 
                                ...
                                <div class="mt-4 flex items-center">
                                    ...
                                    <div class="flex-1">
                                        <input required id="password_confirmation" type="password" name="password_confirmation" class="form-input w-full" 
